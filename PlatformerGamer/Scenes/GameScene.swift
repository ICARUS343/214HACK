...
extension GameScene {
    ...
    func createPlayer() {
        player = SKSpriteNode(imageNamed: "smiling")
        player.name = "Player"
    ...
    func moveCamera() {
        let amountToMove = CGPoint(x: cameraMovePointPerSecond*CGFloat(dt),
                                   y: 0.0)
    ...
    func setupLife() {
        ...
        setupLifePos(node2, i: 2.0, j: 0.0)
